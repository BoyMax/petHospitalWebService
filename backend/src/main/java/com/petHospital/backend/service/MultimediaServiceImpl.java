...
public class MultimediaServiceImpl implements MultimediaService{
	...
	public synchronized ResponseDTO<List<MultimediaDTO>> uploadPic(Map<String, MultipartFile> files, String url, long caseId, int caseType, int type) throws IllegalStateException, IOException {
		Illness illness = illnessRepository.findOne(caseId);
		ResponseDTO<List<MultimediaDTO>> responseDTO = new ResponseDTO<List<MultimediaDTO>>();
		//存储返回多媒体DTO
		List<MultimediaDTO> list = new ArrayList<MultimediaDTO>();
